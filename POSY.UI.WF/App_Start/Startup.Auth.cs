...
using POSY.UI.WF.Configuration;
...
namespace POSY.UI.WF
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            //var _applicationUserManager = container.GetInstance<ApplicationUserManager>();
            //app.CreatePerOwinContext(() => _applicationUserManager);
